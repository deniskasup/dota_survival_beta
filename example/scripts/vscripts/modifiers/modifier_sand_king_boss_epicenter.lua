	...
	if IsServer() then
		...
		for _,enemy in pairs( enemies ) do
			if enemy ~= nil then
				...
				proj.nFXIndex = ParticleManager:CreateParticle( "particles/units/heroes/hero_magnataur/magnataur_shockwave_2.vpcf", PATTACH_CUSTOMORIGIN, nil )
				...
				EmitSoundOn( "Hero_EarthSpirit.Magnetize.StoneBolt", self:GetParent() )
			end
		end
