modifier_npc_dota_hero_bristleback = class({})
...
function modifier_npc_dota_hero_bristleback:DeclareFunctions()
	local funcs = 
	{
...
--当buff创建
function  modifier_npc_dota_hero_bristleback:OnCreated(keys)
	...
	boss_abilitys = {"bristleback_viscous_nasal_goo",'bristleback_quill_spray', 'bristleback_bristleback',"bristleback_warpath","mars_bulwark","nevermore_shadowraze1","nevermore_shadowraze2","nevermore_shadowraze3","hoodwink_acorn_shot","phantom_assassin_stifling_dagger","phantom_assassin_coup_de_grace","sandking_caustic_finale","ursa_overpower","drow_ranger_frost_arrows"}
	boss_items = {"item_refresher","item_nullifier","item_black_king_bar","item_satanic","item_bloodstone","item_monkey_king_bar","item_ex_machina","item_multicast_staff","item_ultimate_scepter_2"}
	...
	--禁用自动施法
	no_cast = {brewmaster_drunken_brawler=1,mars_bulwark=1,troll_warlord_berserkers_rage=1,bounty_hunter_jinada=1,tusk_walrus_punch=1,weaver_geminate_attack=1}
...
--不可驱散
function  modifier_npc_dota_hero_bristleback:IsPurgable()return false end
--永久
function  modifier_npc_dota_hero_bristleback:IsPermanent()return true end
